...
def home():
    ...
    des=ttk.Label(f1, background="#ECE5F0" , text="Download Instagram Video, Photos, IGTV & Reels", anchor=CENTER, font=('', 20, 'bold'),)
    ...
    qut=ttk.Label(f1, text="Download Instagram Video, Photos, IGTV & Reels", background="#ECE5F0" , anchor=CENTER, font=fontSmall)
